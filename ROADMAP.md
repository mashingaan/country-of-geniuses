...
The project grows in stages. Each stage must earn the next one with evidence from real use.

## Phase 0: harness foundation

- Define the mission and public versus private boundary
- Publish the first triage skill
- Define the problem-card shape
- Create integration and jurisdiction contribution contracts
- Keep the registry honest and empty until a path is verified

## Phase 1: one read-only jurisdiction

- Choose one narrow public-service category
- Add one jurisdiction pack from primary sources
- Verify read-only discovery and routing manually
...
- Require a preview and explicit human confirmation
...
- Propose concrete procedural changes with alternatives and costs
- Measure whether a change produced a verified improvement
